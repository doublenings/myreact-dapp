					...
					<div className="col-md-6 offset-md-3">
						...
						<ul className="timeline">
							<li>
								<h4>ลงทะเบียน</h4>
								<h4>08:30</h4>
								<p>รับลงทะเบียนจนถึงเวลา 09:30 พร้อมรับเอกสารประกอบการสัมมนาและอาหารว่าง</p>
							</li>
							<li>
								<h4>เริ่มการสัมมนาเรื่อง</h4>
								<h4>บล็อกเชน...เทคโนโลยีเปลี่ยนโลก</h4>
								<h4>โดย ผศ.ดร.ศุภชัย ไทยเจริญ</h4>
								<h4>09:30</h4>
								<p>สัมมนาเรื่องบล็อกเชน...เทคโนโลยีเปลี่ยนโลก Part1</p>
							</li>
							<li>
							...
							<li>
								...
								<h4>โดย ผศ.ดร.ศุภชัย ไทยเจริญ</h4>
								<h4>13:00</h4>
								<p>สัมมนาเรื่องบล็อกเชน...เทคโนโลยีเปลี่ยนโลก Part2</p>
							</li>
							<li>
								<h4>พักเบรค</h4>
								<h4>15:30</h4>
							...
							<li>
								<h4>สรุปการสัมมนาและกล่าวปิดการสัมมนา</h4>
								<h4>15:50</h4>
								<p>สรุปการสัมมนาและกล่าวปิดการสัมมนา พร้อมถ่ายรูปร่วมกัน</p>
							</li>
						</ul>
					</div>
				</div>
			...
			<div className="section-header">
	            ...
	            <div className="post-preview">
          			...
          			<p className="post-meta">ต้องทำการเข้าสู่ระบบก่อนทุกครั้ง</p>
							...
							<div className="post-preview">
          			<a href="/">
            			<h4 className="post-title">สกุลไฟล์ในการอัปโหลดบทความวิจัย?</h4>
          			</a>
          			<p className="post-meta">ใช้สกุลไฟล์ .pdf ในการอัปโหลดบทความและเมื่ออัปโหลดเรียบร้อยแล้ว คุณยังสามารถดูบทความที่คุณอัปโหลดโดยคลิกลิ้งค์ในคอลัมน์ IPFS HASH</p>
        			</div>
							<div className="post-preview">
          			<a href="/">
